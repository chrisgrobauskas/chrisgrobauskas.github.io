...
description: "When experienced professionals retire, standard handoffs aren't enough. A knowledge bridge keeps decades of institutional insight alive."
...
1. How much of this person's knowledge is documented and current?
2. Is there a named successor who already works alongside them?
3. What's the blast radius if context is lost... one team, one product, or more?
...
If you want a quick gut check, run the [3C Vacation Test](2023/3c-vacation-test). Vacation is a short-term version of the same problem. Retirement just makes it permanent.

## Links

- [Bus factor - Wikipedia](https://en.wikipedia.org/wiki/Bus_factor) - how many people can disappear before the project is in trouble
- [Legacy Teams](2025/legacy-teams) - why modernization efforts need the people who run today's system
- [The 3C Vacation Test](2023/3c-vacation-test) - capability, confidence, and capacity before you're out
