...
- Avoid external calls in transactions if possible. These can make transactions run longer and have external side effects including database contention.
- Keep transactions fast and small to reduce [database contention](/blog/2023/database-contention/) and locking issues.
...
- [Database Contention Is an Application Problem](/blog/2023/database-contention/) - why deadlocks and timeouts trace back to application design
- [Where the Collapsed Lifecycle Breaks](/blog/2026/collapsed-lifecycle/) - how corruption propagates when a bad deployment writes to shared state, and why a code rollback doesn't undo the writes
<!-- - [Microservices and Microliths](/blog/2026/microservices/) - how these tradeoffs play out in architectural decisions -->
